...
type File struct {
	...
	DataDirID   string    `gorethink:"datadir_id,omitempty" json:"datadir_id,omitempty"` // Directory file is located in
	ProjectID   string    `gorethink:"project_id,omitempty" json:"project_id,omitempty"` // Project file is in
